...
redis_port = node['redis']['port'] || '6379' rescue '6379'
...
default['tsuru']['server']['redis-queue']['port'] = redis_port
...
default['tsuru']['server']['docker']['scheduler']['redis-server'] = "127.0.0.1:#{redis_port}"
